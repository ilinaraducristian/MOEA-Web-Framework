...
class TestController(
    ...
    val algorithmRepo: AlgorithmRepository,
    val authorityRepo: AuthorityRepository,
...
//    userRepo.findByUsername("user").get().algorithms.forEach { println(it) }
  }
