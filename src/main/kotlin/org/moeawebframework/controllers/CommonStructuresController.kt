...
import org.moeawebframework.dao.CommonStructureDAO
...
import org.moeawebframework.exceptions.CommonStructureCouldNotBeCreated
...
class CommonStructuresController(
    private val commonStructureDAO: CommonStructureDAO,
    ...
    suspend fun getCommonStructure(
        ...
        val arrayCommonStructure =
            commonStructureDAO.getALlByUserIdAndType(jwt.subject, commonStructureToInt(commonStructure))
    ...
    suspend fun addCommonStrucure(
        ...
        val commonStructure = commonStructureDAO.getByMd5AndType(md5, commonStructureToInt(commonStructureType))
        ...
        val newCommonStructure =
            org.moeawebframework.entities.CommonStructureEntity(
                userId = jwt.subject,
                type = commonStructureToInt(commonStructureType),
                name = name,
                md5 = md5
            )
        val savedCommonStructure = commonStructureDAO.save(newCommonStructure) ?: throw RuntimeException(
            CommonStructureCouldNotBeCreated
        )
    ...
    suspend fun getCommonStructure(
        ...
        val jwt = authentication.principal as Jwt
        val commonStructure =
            commonStructureDAO.getByIdAndType(id, commonStructureToInt(commonStructureType)) ?: throw RuntimeException(
    ...
    suspend fun deleteCommonStructure(
        ...
        if (commonStructure.userId != jwt.subject) throw RuntimeException(CommonStructureExistsAccessDenied)
        commonStructureDAO.delete(commonStructure)
    }
